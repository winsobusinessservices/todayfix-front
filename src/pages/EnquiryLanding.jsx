...
const EnquiryLanding = () => {
  ...
  return (
    <>
      <SEO 
        title="Book Home Services & Repairs"
        description="Fill out our quick enquiry form to request home services, appliance repairs, or cleaning. Get connected with professionals instantly."
      />
