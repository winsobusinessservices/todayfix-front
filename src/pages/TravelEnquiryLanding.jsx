...
const TravelEnquiryLanding = () => {
  ...
  const handleDirectContact = (type) => {
    ...
    if (type === "whatsapp") {
      window.open("https://wa.me/919740371016", "_blank");
    } else if (type === "call") {
      window.location.href = "tel:+919740371016";
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    // Fire Google Ads Conversion
    if (typeof window !== "undefined") {
      console.log("Firing Google Ads Conversion from Travel Enquiry Form...");
      ...
      <div className="min-h-screen bg-surface-primary flex flex-col md:flex-row">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-text-inverted tracking-tight leading-[1.1] mb-6">
            ...
            <span className="text-brand-dark">Today Travels.</span>
          </h1>
          <p className="text-lg text-text-inverted/70 font-medium mb-12 leading-relaxed">
            Whether you need a quick local drop, an airport transfer, or an outstation trip, we have you covered. Here is how it works:
          </p>
          ...
          <div className="space-y-8 relative">
            ...
            <div className="flex items-start gap-5 relative z-10">
              ...
              <div className="pt-2">
                ...
                <p className="text-text-inverted/60 text-sm leading-relaxed">
                  Fill out the quick form on this page with your travel needs. It takes less than 30 seconds.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-5 relative z-10">
              ...
              <div className="pt-2">
                ...
                <p className="text-text-inverted/60 text-sm leading-relaxed">
                  Our team immediately assigns a verified, professional driver to your requested trip.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-5 relative z-10">
              ...
              <div className="pt-2">
                ...
                <p className="text-text-inverted/60 text-sm leading-relaxed">
                  Your cab arrives on time. Enjoy a comfortable and safe journey with upfront pricing.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 md:p-12 lg:p-16 relative">
        <div className="w-full max-w-md bg-surface-secondary rounded-[2rem] p-8 shadow-2xl border border-border-primary relative z-10">
          ...
          <p className="text-text-secondary text-sm font-medium mb-8">
            Enter your trip details below and we'll confirm immediately.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              >
                <option value="" disabled>
                  Select a travel service...
                </option>
                <option value="Local Drop">Local Drop</option>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Enter pickup location, drop location, and date/time..."
                rows={3}
...
export default TravelEnquiryLanding;
