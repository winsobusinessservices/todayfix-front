...
//   // POST /api/business/working-schedules/<uuid>/ (Update Schedule)
//   updateSchedule: async (scheduleId, data) => {
//     const response = await api.post(`/api/business/working-schedules/${scheduleId}/`, data);
//     return response.data;
//   },
...
//     const response = await api.post(`/api/business/availability/${availabilityId}/update/`, data);
//     return response.data;
//   },
// };
