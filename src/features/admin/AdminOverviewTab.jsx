...
const STATS_BY_RANGE = {
  "24h": [
    { label: "Total Users", value: "24,592", trend: "+0.4%", icon: Users, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Active Users", value: "2,142", trend: "+3.1%", icon: Activity, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Total Providers", value: "3,105", trend: "+0.8%", icon: Briefcase, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Verified Providers", value: "2,840", trend: "+0.2%", icon: CheckCircle, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Pending Verifications", value: "18", trend: "-12.5%", icon: ShieldAlert, color: "text-amber-500", bg: "bg-amber-500/10" },
    { label: "Total Businesses", value: "482", trend: "+0.6%", icon: Store, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Active Requests", value: "342", trend: "+15.2%", icon: ClipboardList, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Completed Services", value: "1,231", trend: "+8.4%", icon: CheckCircle, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Total Revenue", value: "₹4.8L", trend: "+18.9%", icon: IndianRupee, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Pending Payouts", value: "₹85K", trend: "-5.0%", icon: Banknote, color: "text-amber-500", bg: "bg-amber-500/10" },
  ],
  "7d": [
    { label: "Total Users", value: "24,592", trend: "+12%", icon: Users, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Active Users", value: "8,142", trend: "+5%", icon: Activity, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Total Providers", value: "3,105", trend: "+18%", icon: Briefcase, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Verified Providers", value: "2,840", trend: "+2%", icon: CheckCircle, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Pending Verifications", value: "142", trend: "-5%", icon: ShieldAlert, color: "text-amber-500", bg: "bg-amber-500/10" },
    { label: "Total Businesses", value: "482", trend: "+8%", icon: Store, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Active Requests", value: "1,204", trend: "+24%", icon: ClipboardList, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Completed Services", value: "45,231", trend: "+14%", icon: CheckCircle, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Total Revenue", value: "₹1.4Cr", trend: "+32%", icon: IndianRupee, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Pending Payouts", value: "₹4.2L", trend: "-2%", icon: Banknote, color: "text-amber-500", bg: "bg-amber-500/10" },
  ],
  "30d": [
    { label: "Total Users", value: "24,592", trend: "+28%", icon: Users, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Active Users", value: "14,890", trend: "+15%", icon: Activity, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Total Providers", value: "3,105", trend: "+22%", icon: Briefcase, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Verified Providers", value: "2,840", trend: "+8%", icon: CheckCircle, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Pending Verifications", value: "412", trend: "+4%", icon: ShieldAlert, color: "text-amber-500", bg: "bg-amber-500/10" },
    { label: "Total Businesses", value: "482", trend: "+14%", icon: Store, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Active Requests", value: "4,890", trend: "+31%", icon: ClipboardList, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Completed Services", value: "182,400", trend: "+22%", icon: CheckCircle, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Total Revenue", value: "₹5.8Cr", trend: "+45%", icon: IndianRupee, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Pending Payouts", value: "₹18.5L", trend: "+3%", icon: Banknote, color: "text-amber-500", bg: "bg-amber-500/10" },
  ],
  "1y": [
    { label: "Total Users", value: "24,592", trend: "+140%", icon: Users, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Active Users", value: "21,450", trend: "+85%", icon: Activity, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Total Providers", value: "3,105", trend: "+95%", icon: Briefcase, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Verified Providers", value: "2,840", trend: "+80%", icon: CheckCircle, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Pending Verifications", value: "1,840", trend: "+15%", icon: ShieldAlert, color: "text-amber-500", bg: "bg-amber-500/10" },
    { label: "Total Businesses", value: "482", trend: "+60%", icon: Store, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Active Requests", value: "48,200", trend: "+110%", icon: ClipboardList, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Completed Services", value: "1,840,200", trend: "+98%", icon: CheckCircle, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Total Revenue", value: "₹62.4Cr", trend: "+135%", icon: IndianRupee, color: "text-text-primary", bg: "bg-surface-secondary" },
    { label: "Pending Payouts", value: "₹1.2Cr", trend: "+12%", icon: Banknote, color: "text-amber-500", bg: "bg-amber-500/10" },
  ],
};
