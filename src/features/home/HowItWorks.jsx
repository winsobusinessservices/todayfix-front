  ...
  return (
    <section className="w-full bg-surface-secondary py-20 px-4 md:px-8 font-sans overflow-hidden border-y border-border-secondary relative">
      ...
      <div className="max-w-3xl mx-auto text-center mb-16">
        {/* Top Black Dash */}
        <div className="w-8 h-1 bg-brand-primary mx-auto mb-6 rounded-full"></div>
    ...
    mockupUI: (
      <div className="w-56 h-40 relative flex items-center justify-center mb-6">
        <div className="w-52 h-36 bg-surface-primary rounded-md shadow-md border border-border-secondary overflow-hidden transform group-hover:-translate-y-2 transition-transform duration-300">
          <div className="w-full h-5 bg-illustration-strong flex items-center px-2 space-x-1.5">
            <div className="w-2 h-2 rounded-full bg-illustration-muted"></div>
            <div className="w-2 h-2 rounded-full bg-illustration-muted"></div>
          </div>
          <div className="p-4">
            <div className="w-16 h-3 bg-illustration-mid rounded-sm mb-4"></div>
            <div className="w-full h-1.5 bg-illustration-soft rounded-full mb-3"></div>
            <div className="w-4/5 h-1.5 bg-illustration-soft rounded-full mb-5"></div>
            <div className="flex items-center gap-2 mb-3">
              <div className="w-3 h-3 bg-illustration-soft border border-border-tertiary rounded-sm"></div>
              <div className="w-20 h-1.5 bg-illustration-soft rounded-full"></div>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 bg-illustration-soft border border-border-tertiary rounded-sm"></div>
              <div className="w-14 h-1.5 bg-illustration-soft rounded-full"></div>
            </div>
      ...
      <div className="w-56 h-40 relative flex items-center justify-center mb-6">
        <div className="relative w-full h-full transform group-hover:-translate-y-2 transition-transform duration-300">
          <div className="absolute top-4 left-2 w-40 h-10 bg-surface-primary rounded shadow-sm border border-border-secondary flex items-center p-2 gap-2 opacity-60">
            <div className="w-4 h-4 bg-illustration-mid rounded-sm"></div>
            <div className="flex-1 space-y-1">
              <div className="h-1.5 w-12 bg-illustration-soft rounded-full"></div>
            </div>
            <div className="w-10 h-3 bg-illustration-strong rounded-sm"></div>
          </div>
          <div className="absolute top-14 left-8 w-44 h-12 bg-surface-primary rounded shadow-lg border border-border-secondary flex items-center p-2.5 gap-2 z-20">
            <div className="w-5 h-5 bg-illustration-mid rounded-sm"></div>
            <div className="flex-1 space-y-1.5">
              <div className="h-1.5 w-14 bg-illustration-soft rounded-full"></div>
              <div className="h-1 w-8 bg-illustration-soft rounded-full"></div>
            </div>
            <div className="w-12 h-3.5 bg-illustration-strong rounded-sm"></div>
          </div>
          <div className="absolute bottom-4 left-4 w-40 h-10 bg-surface-primary rounded shadow-sm border border-border-secondary flex items-center p-2 gap-2 z-10 opacity-80">
            <div className="w-4 h-4 bg-illustration-mid rounded-sm"></div>
            <div className="flex-1 space-y-1">
              <div className="h-1.5 w-10 bg-illustration-soft rounded-full"></div>
            </div>
            <div className="w-10 h-3 bg-illustration-strong rounded-sm"></div>
          </div>
        </div>
      ...
      <div className="w-56 h-40 relative flex items-center justify-center mb-6">
        <div className="relative w-48 h-36 transform group-hover:-translate-y-2 transition-transform duration-300">
          <div className="absolute top-0 left-0 w-36 h-32 bg-surface-primary rounded-md shadow-sm border border-border-secondary overflow-hidden">
            <div className="w-full h-4 bg-illustration-strong"></div>
            <div className="p-3">
              <div className="w-8 h-8 bg-illustration-mid rounded-sm mb-3"></div>
              <div className="w-full h-1.5 bg-illustration-soft rounded-full mb-1.5"></div>
              <div className="w-full h-1.5 bg-illustration-soft rounded-full mb-1.5"></div>
              <div className="w-2/3 h-1.5 bg-illustration-soft rounded-full mb-4"></div>
              <div className="flex gap-2">
                <div className="w-1/2 h-1 bg-illustration-soft rounded-full"></div>
                <div className="w-1/2 h-1 bg-illustration-soft rounded-full"></div>
              </div>
            </div>
          </div>
          <div className="absolute bottom-0 right-0 w-20 h-28 bg-surface-primary rounded-md shadow-xl border border-border-primary overflow-hidden z-20">
            <div className="w-full h-3 bg-illustration-strong"></div>
            <div className="p-2 flex flex-col items-center mt-2">
              <div className="w-12 h-1 bg-illustration-soft rounded-full mb-2"></div>
              <div className="w-14 h-4 bg-illustration-strong rounded-sm mb-3"></div>
              <div className="w-14 h-1 bg-illustration-soft rounded-full mb-2"></div>
              <div className="w-14 h-4 bg-illustration-strong rounded-sm mb-3"></div>
            </div>
          </div>
        </div>
    ...
    mockupUI: (
      <div className="w-56 h-40 relative flex items-end justify-center pb-2 mb-6 transform group-hover:-translate-y-2 transition-transform duration-300">
        <div className="w-14 h-20 bg-surface-primary border border-border-secondary shadow-sm transform -rotate-6 translate-x-3 opacity-60 p-2 flex flex-col items-center z-0">
          <div className="w-6 h-0.5 bg-illustration-soft mt-2 mb-1"></div>
          <div className="w-8 h-0.5 bg-illustration-soft mb-1"></div>
          <div className="w-4 h-0.5 bg-illustration-soft"></div>
        </div>
        <div className="w-20 h-28 bg-surface-primary border border-border-secondary shadow-xl z-20 relative p-3 flex flex-col items-center">
          <div className="absolute -top-3 -right-3 w-8 h-8 bg-illustration-soft rounded-full flex items-center justify-center shadow-sm">
            <div className="w-6 h-6 bg-illustration-strong rounded-full flex items-center justify-center text-white">
              <svg
          ...
          <div className="flex items-end gap-1 mt-4 h-8 border-b border-border-secondary w-full justify-center pb-1">
            <div className="w-2.5 h-3 bg-illustration-mid rounded-t-sm"></div>
            <div className="w-2.5 h-7 bg-illustration-mid rounded-t-sm"></div>
            <div className="w-2.5 h-5 bg-illustration-mid rounded-t-sm"></div>
          </div>
          <div className="w-12 h-1.5 bg-illustration-strong rounded-full mt-4"></div>
        </div>
        <div className="w-14 h-20 bg-surface-primary border border-border-secondary shadow-sm transform rotate-6 -translate-x-3 opacity-60 p-2 flex flex-col items-center z-10">
          <div className="w-8 h-0.5 bg-illustration-soft mt-3 mb-1"></div>
          <div className="w-6 h-0.5 bg-illustration-soft"></div>
        </div>
      </div>
    ),
    mobileArrow: null,
