      ...
      <div className="max-w-[1400px] w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-5">
          {servicesPageData.map((service) => (
            <div
              key={service.id}
              className="group bg-surface-primary rounded-lg p-2.5 border border-border-primary shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-300 flex flex-col"
            >
              ...
              <div className="mt-4 px-1 pb-1">
                <button className="w-full bg-surface-dark text-text-inverted py-2.5 rounded-lg font-semibold text-xs hover:bg-zinc-800 transition-colors duration-300 flex items-center justify-center gap-1.5 group/btn shadow-sm">
                  View Providers
                  <svg
