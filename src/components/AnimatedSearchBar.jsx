    ...
    <div className="flex items-center justify-center font-sans px-4 sm:px-6 w-full">
      ...
      <div className="relative w-full max-w-xl group">
        ...
        <form
          ...
          className="relative flex items-center w-full h-12 bg-zinc-700 rounded-full border border-border-dark focus-within:border-border-primary focus-within:ring-4 focus-within:ring-cyan-500/10 transition-all shadow-2xl overflow-hidden"
        >
          {/* Search Icon */}
